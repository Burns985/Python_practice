...
def hillClimbing():
    graph = {
        ...
        'H': Node('H', None, [('F', 1), ('I', 1)], 0, (4, 1)),
        'I': Node('I', None, [('H', 1), ('J', 1)], 0, (2, 2)),
        'J': Node('J', None, [('G', 1), ('K', 1)], 0, (3, 2)),
        'K': Node('K', None, [('L', 1)], 0, (4, 2)),
        'L': Node('L', None, [('K', 1), ('M', 1)], 0, (5, 2)),
        'M': Node('M', None, [('H', 1), ('N', 1), ('R', 1)], 0, (0, 3)),
        'N': Node('N', None, [('I', 1), ('M', 1), ('S', 1)], 0, (1, 3)),
        'O': Node('O', None, [('P', 1), ('U', 1)], 0, (3, 3)),
        'P': Node('P', None, [('K', 1), ('Q', 1)], 0, (4, 3)),
        'Q': Node('Q', None, [('L', 1), ('R', 1), ('S', 1)], 0, (5, 3)),
        'R': Node('R', None, [('M', 1), ('S', 1)], 0, (0, 4)),
        'S': Node('S', None, [('N', 1), ('T', 1)], 0, (1, 4)),
        'T': Node('T', None, [('S', 1), ('U', 1), ('W', 1)], 0, (2, 4)),
        'U': Node('U', None, [('O', 1), ('V', 1), ('W', 1)], 0, (3, 4)),
        'V': Node('V', None, [('P', 1), ('V', 1)], 0, (5, 4)),
    ...
    while parentNode != goalState:
        ...
        for child_state, action_cost in graph[parentNode].actions:
            if child_state not in explored:
                child_node = graph[child_state]

                childCost = math.sqrt(
                    (graph[goalState].heuristic[0] - child_node.heuristic[0]) ** 2 +
                    (graph[goalState].heuristic[1] - child_node.heuristic[1]) ** 2
                )

                if childCost < minChildCost:
                    bestNode = child_state
